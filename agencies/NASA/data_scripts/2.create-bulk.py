...
with open(os.path.join(basedir, "data", "index", "nasa-index"),"w") as out:
    with open(os.path.join(basedir, "data", "nsf_sample.json"), "r") as s:
        nsf = json.loads(s.read())

        with open(os.path.join(basedir, "data", "awards", "research-nasa.json"), "r") as f:
            for doc in f.readlines():
                ...
                doc["award_effective_date"] = reformat(doc["award_effective_date"])
